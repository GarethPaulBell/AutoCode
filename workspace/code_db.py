...
class Function:
    def __init__(self, name: str, description: str, code_snippet: str, modules: Optional[List[str]] = None, tags: Optional[List[str]] = None):
        ...
        self.modules: List[str] = modules or []  # List of module names
        self.dependencies: List[str] = []  # List of function_ids this function depends on
        self.tags: List[str] = tags or []  # List of arbitrary tags
    ...
    def __repr__(self):
        return (f"<Function {self.function_id}: {self.name}, "
                ...
                f"Modules: {self.modules}, Dependencies: {self.dependencies}, Tags: {self.tags}>")
